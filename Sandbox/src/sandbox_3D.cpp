...
sandbox_3D::sandbox_3D()
	: layer("example"), m_camera(45.f, 1280.f, 720.f, 0.1f, 100.f),
	m_camera_position(glm::vec3(0.f, 0.f, 3.f)), m_camera_rotation(0.f), m_colour(1.f), m_position(0.f), m_origin(1.f), m_scale(0.5f), m_rotation(0.f), m_transform(1.f)
{
}
...
void sandbox_3D::on_detach()
{

}

void sandbox_3D::on_update(Robin::timestep delta_time)
{
	...
	Robin::render_command::set_viewport(0, 0, 1280, 720);
...
void sandbox_3D::on_imgui_render()
{
...
void sandbox_3D::on_event(Robin::event& e)
{
	Robin::event_dispatcher dispatcher(e);
	dispatcher.dispatch<Robin::mouse_button_pressed_event>(RB_BIND_EVENT_FN(sandbox_3D::on_button_press));
	dispatcher.dispatch<Robin::mouse_button_released_event>(RB_BIND_EVENT_FN(sandbox_3D::on_button_release));
}

bool sandbox_3D::on_button_press(Robin::mouse_button_pressed_event& e)
{
...
bool sandbox_3D::on_button_release(Robin::mouse_button_released_event& e)
{
	if (e.get_mouse_button() == RB_MOUSE_BUTTON_2)
	{
...
bool sandbox_3D::is_cursor_visible()
{
